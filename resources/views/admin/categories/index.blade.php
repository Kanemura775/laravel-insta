                ...
                <tbody>
                    @forelse($all_categories as $category)
                        <tr>
                            ...
                            <td>
                                {{-- edit button --}}
                                <button class="btn btn-outline-warning btn-sm me-2" data-bs-toggle="modal" data-bs-target="#edit-catogry-{{$category->id}}" title="Edit">
                                    <i class="fa-solid fa-pen"></i>
                                </button>
                                {{-- delete button --}}
                                <button class="btn btn-outline-danger btn-sm me-2" data-bs-toggle="modal" data-bs-target="#delete-catogry-{{$category->id}}" title="Delete">
