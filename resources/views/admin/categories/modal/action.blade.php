{{-- Edit --}}
<div class="modal fade" id="edit-catogry-{{$category->id}}">
...
{{-- Delte --}}
<div class="modal fade" id="delete-catogry-{{$category->id}}">
    <div class="modal-dialog">
        <form action="{{route('admin.categories.destroy',$category->id)}}" method="POST">
            ...
            <div class="modal-content border-danger">
                ...
                <div class="modal-body">
                    ...
                    <p class="fw-light">This action will affect all the posts under this category. <br> Posts without a category will fall under Uncategorized. </p>
                </div>
                <div class="modal-footer">
